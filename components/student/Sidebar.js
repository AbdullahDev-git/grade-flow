...
const navItems = [
  ...
  { href: "/student/assignments", label: "All Assignments", icon: ClipboardList },
];

export default function StudentSidebar({ mobileOpen, onClose, collapsed }) {
      ...
      <div className="p-5 border-b border-white/10">
        {collapsed ? (
          ...
          <>
            ...
            <p className="text-sidebar-text text-xs mt-1">Student Portal</p>
          </>
        )}
      </div>
